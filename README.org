[[https://github.com/Anoncheg1/copilot-chat-completions/workflows/ci/badge.svg]]
...
* Token
You need fine-grainded token with permission to "copilot chat" and enabled Copilot in settings->Copilot->Features.
